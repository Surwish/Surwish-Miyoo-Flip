...
"/mnt/SDCARD/App/SystemTools/Menu/TOOLS/CUE - Generator.sh"
...
rm "/mnt/SDCARD/Roms/PS/PS_cache6.db"
sync

if [ "$#" -eq 0 ]; then # when launched by GLO menu, without args.

  /mnt/SDCARD/System/usr/miyoo/scripts/infoscreen.sh -m "$(cat "$count_m3u") playlist files created." -t 3
