...
/mnt/SDCARD/System/usr/miyoo/scripts/mainui_state_update.sh "Syncthing" "enabled"

sleep 1

IP=$(ifconfig wlan0 2>/dev/null | awk '/inet addr:/ { print substr($2, 6) }')
echo "Syncthing: http://$IP:8384"
/mnt/SDCARD/System/usr/miyoo/scripts/infoscreen.sh -m "Syncthing: http://$IP:8384" -t 4
