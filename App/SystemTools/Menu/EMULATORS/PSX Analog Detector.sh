...
DB_NAME="/mnt/SDCARD/System/usr/miyoo/scripts/Sony - PlayStation - analog/Sony - PlayStation - analog.db"
...
/mnt/SDCARD/System/usr/miyoo/scripts/infoscreen.sh -m "Detecting Dual Shock compatible games..." -t 0.5
...
apply_dual_shock_remap() {
  ...
  for system in "PCSX-ReARMed" "DuckStation" "SwanStation"; do
    ...
    if [ -e "$filepath" ]; then
      ...
      /mnt/SDCARD/System/usr/miyoo/scripts/patch_ra_cfg.sh "/tmp/$filename" "$filepath"
      rm "/tmp/$filename"
    else
...
echo "=================================================================="
cd "$RA_DIR"
HOME="$RA_DIR/" "$RA_DIR/ra64.trimui" --appendconfig "/mnt/SDCARD/System/usr/miyoo/scripts/Sony - PlayStation - analog/Sony - PlayStation - analog.cfg" --scan="/mnt/SDCARD/Roms/PS"
echo "---------------------------------"
...
/mnt/SDCARD/System/usr/miyoo/scripts/infoscreen.sh -m "$(cat "$analog_count") analog compatible game(s) detected." -t 4
