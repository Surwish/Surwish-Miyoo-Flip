...
if [ ! -f ./nav-logo-off.png ]; then
    ...
    cp /mnt/SDCARD/System/usr/miyoo/res/skin/empty.png ./nav-logo.png
else
...
if [ ! -f ./icon-back-off.png ]; then
    ...
    cp /mnt/SDCARD/System/usr/miyoo/res/skin/empty.png ./icon-back.png
else
    echo "The file ./nav-logo-off.png already exists."
fi
...
/mnt/SDCARD/System/usr/miyoo/scripts/mainui_state_update.sh "TOP LEFT LOGO" "disabled"