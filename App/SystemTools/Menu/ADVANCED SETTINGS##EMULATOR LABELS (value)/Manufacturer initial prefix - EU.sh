...
/mnt/SDCARD/System/usr/miyoo/scripts/infoscreen.sh -m "Applying \"$(basename "$0" .sh)\" icons by default..."

# Get the script name without the extension
script_name=$(basename "$0" .sh)

# Path to the SQLite database
db_path="/mnt/SDCARD/System/usr/miyoo/scripts/emulators_list.db"
...
/mnt/SDCARD/System/usr/miyoo/scripts/mainui_state_update.sh "EMULATOR LABELS" "$script_name"
