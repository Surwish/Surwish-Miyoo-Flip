...
/mnt/SDCARD/System/usr/miyoo/scripts/infoscreen.sh -m "Loading..."

# For faster loading we check if we have to rebuild the database

show_json_path="/mnt/SDCARD/Emu/show.json"
database_file="/mnt/SDCARD/App/Scraper/Menu/Menu_cache6.db"

crc_Emus_file="/mnt/SDCARD/App/Scraper/show_json_crc.txt"
crc_DB_file="/mnt/SDCARD/App/Scraper/current_crc_DB.txt"

if [ ! -f "$show_json_path" ]; then
  /mnt/SDCARD/App/EmuCleaner/launch.sh -s
  rm "$database_file"
  rm "$crc_Emus_file"
  sync
fi
...
# Calculate current CRC32 of show.json (list of displayed emulators) and Menu_cache6.db
...
echo "Current  show.json CRC32: $current_crc_Emus      |    Current   Menu_cache6.db CRC32: $current_crc_DB"
echo "Previous show.json CRC32: $previous_crc_Emus     |    Previous  Menu_cache6.db CRC32: $previous_crc_DB"
...
search_path="/mnt/SDCARD/App/Scraper/Menu/"
img_path="/mnt/SDCARD/App/Scraper/Menu/Imgs"
...
cp /mnt/SDCARD/App/Scraper/GoTo_Scraper_List.json /tmp/state.json
sync
