...
if [ -f "$ScraperConfigFile" ]; then
    ...
    regionsDB="/mnt/SDCARD/System/usr/miyoo/scripts/scraper/regions.db"
...
ExtList=$(jq -r '.extlist' "/mnt/SDCARD/Emu/$CurrentSystem/config.json")
...
# wget  "$MediaURL" -O \"/mnt/SDCARD/Imgs/$CurrentSystem/$romNameNoExtension.png\"
