#!/bin/sh
export PATH="/mnt/SDCARD/System/usr/miyoo/scripts/:/mnt/SDCARD/System/bin:/usr/trimui/bin:$PATH"
export LD_LIBRARY_PATH="/mnt/SDCARD/System/lib:/mnt/SDCARD/Apps/PortMaster/PortMaster:/usr/miyoo/lib:$LD_LIBRARY_PATH"
...
if /mnt/SDCARD/System/bin/wget -q --spider https://github.com >/dev/null; then
    ...
    button=$(/mnt/SDCARD/System/usr/miyoo/scripts/getkey.sh "A B" 2>/dev/null)
    if [ "$button" = "B" ]; then
        exit_simple_terminal
    fi
fi
...
/mnt/SDCARD/System/usr/miyoo/scripts/portmaster_runtimes_check.sh # will create default config files too
sync
