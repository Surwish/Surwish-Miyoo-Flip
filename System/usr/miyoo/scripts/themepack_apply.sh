...
if [ -n "$packname" ] && [ -n "$style" ]; then
	...
	/mnt/SDCARD/System/usr/miyoo/scripts/infoscreen.sh -m "packname and style variables are not defined." -c red -t 4
	exit
fi
...
if [ -n "$theme" ]; then
    if [ -d "/mnt/SDCARD/Themes/${theme}" ]; then
        /mnt/SDCARD/System/usr/miyoo/scripts/infoscreen.sh -m "Applying \"${theme}\" theme." -t 1
...
if [ -n "$bootlogo" ]; then
    if [ -f "/mnt/SDCARD/Apps/BootLogo/Images/$bootlogo" ]; then
        /mnt/SDCARD/System/usr/miyoo/scripts/infoscreen.sh -i "/mnt/SDCARD/Apps/BootLogo/Images/$bootlogo" -m "Flashing logo..." -fs 100 -c green -t 0.5
        ...
        /mnt/SDCARD/System/usr/miyoo/scripts/infoscreen.sh -m "\"Apps/BootLogo/Images/$bootlogo\" does not exist !!" -fs 27 -c red -t 3
    fi
fi
...
if [ -n "$icon" ]; then
    if [ -f "/mnt/SDCARD/Apps/SystemTools/Menu/ADVANCED SETTINGS##ICONS (value)/${icon}.sh" ]; then
        ...
        /mnt/SDCARD/System/usr/miyoo/scripts/infoscreen.sh -m "\"Apps/SystemTools/Menu/ADVANCED SETTINGS##ICONS (value)/${icon}.sh\" does not exist !!" -fs 22 -c red -t 3
    fi
fi
...
if [ -n "$background" ]; then
    if [ -f "/mnt/SDCARD/Apps/SystemTools/Menu/ADVANCED SETTINGS##BACKGROUNDS (value)/${background}.sh" ]; then
        ...
        /mnt/SDCARD/System/usr/miyoo/scripts/infoscreen.sh -m "\"Apps/SystemTools/Menu/ADVANCED SETTINGS##BACKGROUNDS (value)/${background}.sh\" does not exist !!" -fs 22 -c red -t 3
    fi
fi
...
if [ -n "$emulabels" ]; then
    if [ -f "/mnt/SDCARD/Apps/SystemTools/Menu/ADVANCED SETTINGS##EMULATOR LABELS (value)/${emulabels}.sh" ]; then
        ...
        /mnt/SDCARD/System/usr/miyoo/scripts/infoscreen.sh -m "\"Apps/SystemTools/Menu/ADVANCED SETTINGS##EMULATOR LABELS (value)/${emulabels}.sh\" does not exist !!" -fs 22 -c red -t 3
    fi
fi
...
if [ -n "$packname" ]; then
    if [ -f "/mnt/SDCARD/trimui/res/crossmix-os/theme_$packname/icon.ico" ]; then
        /mnt/SDCARD/System/usr/miyoo/scripts/set_ra_cfg.sh /mnt/SDCARD/autorun.inf icon "trimui/res/crossmix-os/theme_$packname/icon.ico"
    else
        /mnt/SDCARD/System/usr/miyoo/scripts/set_ra_cfg.sh /mnt/SDCARD/autorun.inf icon "trimui/res/crossmix-os/icon.ico"
    fi
fi
...
/mnt/SDCARD/System/usr/miyoo/scripts/mainui_state_update.sh "THEME PACK" "$packname"


/mnt/SDCARD/System/usr/miyoo/scripts/infoscreen.sh -m "\"$packname\" applied" -t3
