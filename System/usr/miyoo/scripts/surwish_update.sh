...
if [ ! -f /mnt/SDCARD/System/usr/miyoo/scripts/update_common.sh ]; then 
  /mnt/SDCARD/System/bin/7zz e "$UPDATE_FILE" "System/usr/trimui/scripts/update_common.sh" -o/mnt/SDCARD/System/usr/miyoo/scripts -y
fi 
...
. /mnt/SDCARD/System/usr/miyoo/scripts/themepack_apply.sh
EOF
...
/mnt/SDCARD/System/usr/miyoo/scripts/reset_list.sh "PSP"
...
extract_keys() {
  ...
  /mnt/SDCARD/System/usr/miyoo/scripts/patch_ra_cfg.sh "$temp_file" "$target_file"
