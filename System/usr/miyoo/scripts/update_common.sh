...
GITHUB_REPOSITORY=SurwishOS/Surwish-OS
updatedir="/mnt/SDCARD/System/updates"
Local_SurwishVersion="$(cat "/mnt/SDCARD/System/usr/miyoo/surwish-version.txt")"
...
check_available_space() {
    ...
    if [ "$available_space" -lt "$required_space" ]; then
        ...
        echo "Surwish-OS update requires $required_space MB of free space."
        return 1
    else
